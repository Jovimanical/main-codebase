	...
	window.initializeCallback = function HomePageGoogleCallback() {
	    ...
	    if (window.has_coordinate) {
	        ...
	        (function () {
	            ...
	            map_latitude = parseFloat(window.map_latitude);
	            map_longitude = parseFloat(window.map_longitude);
	            directionsDisplay = new google.maps.DirectionsRenderer({ draggable: true });
	            directionsService = new google.maps.DirectionsService();
	
	            console.log(geocoder);
	            latlng = new google.maps.LatLng(map_latitude, map_longitude);
	            mapOptions = {
	                zoom: 11,
	    ...
	    function responseCallback(autocomplete) {
	        ...
	        console.log(place);
	        $('#tutor_address').val(place.name + ", " + place.vicinity);
	        $('#routeGo').click();
	    }
	
	    //Modal Form for mobile devices
	    Utils.GoogleAutoComplete($('#tutor_address'), responseCallback);
	};
...
/******/ });
//# sourceMappingURL=job_details.bundle.js.map