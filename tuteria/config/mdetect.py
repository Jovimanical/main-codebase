...
class UAgentInfo(object):
    ...
    def detectWindowsPhone(self):
        ...
        """
        return self.detectWindowsPhone7() or self.detectWindowsPhone8()
    ...
    def detectGamingHandheld(self):
        ...
        """
        return (
            UAgentInfo.devicePlaystation in self.__userAgent
    ...
    def detectMobileQuick(self):
        ...
        if (
            UAgentInfo.engineObigo in self.__userAgent
