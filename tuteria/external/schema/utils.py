...
from graphene_utils.utils import *
...
#     def build_form_fields(self, key, fields=None, name=None, is_list=False, **kwargs):
#         for i in [fields]:
#             if not i:
#                 raise NotImplementedError(f"Missing parameter for {key} ")
#         if not name:
#             return (key, get_graphene_type(*fields, kwargs))
#         klass = type(name, (graphene.InputObjectType,), get_graphene_types(fields))
#         if is_list:
...
#                 "Arguments": type("Arguments", (), m_instance.get_form_fields()),
#                 "mutate": m_instance.mutate,
#             },
#         )
