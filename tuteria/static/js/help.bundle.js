...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  var parentLink = $('.bs-docs-sidebar #sidebar li.sub-item');
	  function removeActiveClass() {
	    $.each(parentLink, function (index, val) {
	  ...
	  var bh = Utils.getBloodhoundInstance('question', Urls['help:article_ajax']());
	  bh.initialize();
	  Utils.ApplyTypeaheadToInput($('#skill_search'), 'question', 'question', bh, function (obj, datum, name) {
	    console.log(datum);
	    $(this).typeahead('val', datum.question);
	    $("#home_search_form").submit();
	  });
	
	  // $('.parentArticle').on('click', function (e) {
	  //     e.preventDefault();
	  //     var ul = $(this).find('+ ul');
	  //     if (ul.is(':hidden')) {
	  //         ul.removeClass('hide');
	  ...
	  $('.see-more').click(function (e) {
	    e.preventDefault();
	    $(this).closest("div.row").next().find('.more').toggleClass('hide');
	  });
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
