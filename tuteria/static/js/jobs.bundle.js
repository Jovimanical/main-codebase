...
/***/ function(module, exports, __webpack_require__) {
	...
	window.initializeCallback = function HomePageGoogleCallback() {
	    ...
	    function responseCallback(autocomplete) {
	        ...
	        var searchTag = Utils.filterOptionByText($('#id_state'), state);
	        if (searchTag) {
	            searchTag.attr("selected", true);
	        }
	        var searchTag2 = Utils.filterOptionByText($('.mobile #id_state'), state);
	        if (searchTag2) {
	            searchTag.attr("selected", true);
	        }
	
	        $('#id_vicinity').val(place.name + ", " + place.vicinity);
	        $('#id_latitude').val(place.geometry.location.lat());
	        $('#id_longitude').val(place.geometry.location.lng());
	        $('.mobile #id_vicinity').val(place.name + ", " + place.vicinity);
	        $('.mobile #id_latitude').val(place.geometry.location.lat());
	        $('.mobile #id_longitude').val(place.geometry.location.lng());
	    }
	
	    Utils.GoogleAutoComplete($('#id_vicinity'), responseCallback);
	    Utils.GoogleAutoComplete($('.mobile #id_vicinity'), responseCallback);
	...
	$(function () {
	    ...
	    function small() {
	        var vicinity = $('.mobile #id_vicinity').val();
	        if (vicinity == "") {
	            $('.mobile #id_latitude').val("");
	            $('.mobile #id_longitude').val("");
	        }
	    }
