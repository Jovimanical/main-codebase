...
def cloudinary_url(context, source, options_dict={}, **options):
    ...
    return ImageService.get_url(source, **options)
    # try:
...
def cloudinary_tag(context, image, options_dict={}, **options):
    ...
    # except KeyError:
    #     pass
    return ImageService.get_image(image, **options)
